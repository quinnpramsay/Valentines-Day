...
2. **Click "No"** - Image appears, you're forced to wait 5 seconds, heading changes to "No is not an option.", button starts moving away
3. **Click "No" again** - "I said no is not an option." message appears, button continues moving
4. **Try "No" again** - Button keeps moving (impossible to click)
