...
2. **Click "No"** - Image appears, heading changes to "No is not an option.", "Try Again" button shows
3. **Click "Try Again"** - Returns to "Will you be my Valentine?", button starts moving away
4. **Click "No" again** - "I said no is not an option." message appears, button continues moving
5. **Try "No" again** - Button keeps moving (impossible to click)
6. **Click "Yes"** - Should see:
   - ✨ Confetti animation
