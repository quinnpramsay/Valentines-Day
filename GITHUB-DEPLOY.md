...
3. **Add Your Files**
   ...
   - **Important:** Make sure to include `first-no-image.png` (the custom photo)
...
2. **Click "No"** - Should show your custom "OHMYGODDDD" image
3. **Click "No" again** - Warning message appears
4. **Try "No" again** - Button moves away (impossible to click)
...
- [ ] Project uploaded to GitHub (including `first-no-image.png`)
